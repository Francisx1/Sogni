...
// Please replace with your own credentials via environment variables
const USERNAME = process.env.SOGNI_USERNAME || 'wangxunye8';
const PASSWORD = process.env.SOGNI_PASSWORD || 'a13308358805';
